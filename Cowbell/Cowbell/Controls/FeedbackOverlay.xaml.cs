...
namespace Centapp.Cowbell.Controls
{
    public partial class FeedbackOverlay : UserControl
    {
        ...
        private void FeedbackOverlay_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            if (((App)Application.Current).AlreadyAskedRating)
            {
            ...
            if (FeedbackHelper.Default.State == FeedbackState.FirstReview)
            {
                ...
                ((App)Application.Current).AlreadyAskedRating = true;
            }
        ...
        {
            this.Title = string.Format(AppResources.RatingTitle, ((App)Application.Current).AppTitle);
